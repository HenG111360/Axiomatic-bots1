...
// ============================================
// 🔥 ПРЯМАЯ ССЫЛКА НА ТВОЙ ФОН (CATBOX)
// ============================================
const BACKGROUND_URL = 'https://files.catbox.moe/urnvk4.png';

module.exports = {
    data: new SlashCommandBuilder()
        .setName('profile')
        .setDescription('📊 Показывает красивый профиль')
    ...
    async execute(interaction) {
        ...
        ctx.font = '40px "Arial", sans-serif';
        ctx.fillStyle = '#ffd700';
        ctx.fillText('1000+', 100, 340); // можно заменить на реальный топ позже
